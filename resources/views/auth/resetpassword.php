...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($password === $confirmPassword) {
        ...
        $stmt = $conn->prepare("UPDATE kupac SET Lozinka = ? WHERE Email = ?");
        ...
        if ($stmt->execute()) {
            ...
            $message = "Greška prilikom postavljanja nove lozinke";
          ...
          Promijeni lozinku</h5>
            ...
            <div class="col mb-3 mt-3">
                <label for="confirm_password"><i 
                  class="fa fa-lock"></i> Potvrdi lozinku</label>
            ...
            <div class="col mb-2 mt-4">
                ...
                color: navy;"><a href="./register.php"
                  ...
                  Stvori račun</a> ili <a href="./login.php"
                        style="text-decoration: none;">Prijava</a></p>
            </div>
        </form>
    </div>
    <script>
